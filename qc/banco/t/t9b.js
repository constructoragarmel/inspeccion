...
ok('Secciones: 9 base (la memoria corrupta se ignora)', GENERAL.length === 9, GENERAL.length);
ok('Partidas recordadas corruptas ([1,2,3]): no rompen', $$('.item').length === 42, $$('.item').length);
